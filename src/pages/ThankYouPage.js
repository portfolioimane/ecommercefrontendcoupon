...
const ThankYouPage = () => {
    ...
    const calculateFinalTotal = (subtotal, discount) => {
        return (Number(subtotal) - (Number(discount) || 0)).toFixed(2);
    };
            ...
            {loading ? (
                ...
                <div className="order-details">
                    ...
                    <div className="order-summary">
                        ...
                        <p><strong>Total After Discount:</strong> {calculateFinalTotal(calculateSubtotal(recentOrder.items), recentOrder.discount)} MAD</p>
                    </div>
                </div>
            ) : (
